...
if __name__ == "__main__":
    ...
    combinations = [
        ...
        ("Gas_CandDiam", f"{args.caseStudyFolder}Gas_CandDiam.xlsx", ExcelReader.get_Gas_CandDiam, ew.write_Gas_CandDiam),
        ("Gas_Demand", f"{args.caseStudyFolder}Gas_Demand.xlsx", ExcelReader.get_Gas_Demand, ew.write_Gas_Demand),
        ("Gas_Network", f"{args.caseStudyFolder}Gas_Network.xlsx", ExcelReader.get_Gas_Network, ew.write_Gas_Network),
        ("Gas_NodeInfo", f"{args.caseStudyFolder}Gas_NodeInfo.xlsx", ExcelReader.get_Gas_NodeInfo, ew.write_Gas_NodeInfo),
        ("Gas_Source", f"{args.caseStudyFolder}Gas_Source.xlsx", ExcelReader.get_Gas_Source, ew.write_Gas_Source),
